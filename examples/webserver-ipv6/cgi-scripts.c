...
generate_file_stats(void *arg)
{
  ...
  if (tmp[0]=='.') { 
    ...
    numprinted=httpd_snprintf((char *)uip_appdata, uip_mss(), httpd_cgi_filestat1, 0, 
...
//    }
  ...
  /* Count for specified file */
    ...
    numprinted=httpd_snprintf((char *)uip_appdata, uip_mss(), httpd_cgi_filestat3, 0);
  }
  return numprinted;
}
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
uint8_t
httpd_cgi_sprint_ip6(uip_ip6addr_t addr, char * result)
{
