...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/inga/test-deluge.c</source>
      <commands EXPORT="discard">make clean TARGET=inga
make APPS=deluge test-deluge.inga TARGET=inga</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/inga/test-deluge.inga</firmware>
