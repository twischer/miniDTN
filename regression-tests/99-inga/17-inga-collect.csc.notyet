...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/inga/inga-collect.c</source>
      <commands EXPORT="discard">make clean TARGET=inga
make inga-collect.inga TARGET=inga</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/inga/inga-collect.inga</firmware>
